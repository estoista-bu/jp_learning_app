...
exports.allWords = void 0;
const kana_1 = require("@/data/kana");
const n5_words_1 = require("@/data/n5-words");
const n4_words_1 = require("@/data/n4-words");
const n3_words_1 = require("@/data/n3-words");
const n2_words_1 = require("@/data/n2-words");
const n1_words_1 = require("@/data/n1-words");
exports.allWords = [
    ...
    ...n1_words_1.n1Words,
    // Deck: Hiragana
    ...kana_1.hiragana.map((kana, i) => ({ id: `h-${i}`, japanese: kana.j, reading: kana.j, meaning: kana.r, deckId: 'hiragana' })),
    // Deck: Katakana
    ...kana_1.katakana.map((kana, i) => ({ id: `k-${i}`, japanese: kana.j, reading: kana.h, meaning: kana.r, deckId: 'katakana' })),
];
